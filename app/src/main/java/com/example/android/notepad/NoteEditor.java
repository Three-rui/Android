...
//        TextView tv = (TextView) findViewById(R.id.note);
        ...
        case R.id.menu_revert:
            ...
            case R.id.yellow_font:
                ...
                break;
//            case R.id.one:
//                tv.setBackgroundResource(R.drawable.tiger);
//                break;
//            case R.id.two:
//                tv.setBackgroundResource(R.drawable.cute);
//                break;
//            case R.id.three:
//                tv.setBackgroundResource(R.drawable.back_green);
//                break;
        }
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
         ...
         * automatically notified when the Cursor for th    e URI changes, and the UI is
         * updated.
